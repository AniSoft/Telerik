namespace _02.TestIEnumerableExtension
{
    ...
    class TestIEnumerableExtension
    {
        static void Main()
        {
            ...
            List<Human> humanList = new List<Human>()
            {
             ...
             // Method in delegate is set without parametars
            Console.WriteLine(humanList.Average(new CustomTypeNumericalValue<Human>(Human.GetHeight))); 
    ...
    public class Human :IComparable
    {
        ...
        // must be static
        public static decimal GetHeight(Human h) 
        {
            return (decimal)h.Height;
        }
        
        // compare method must get object type
